...
//expectes another person to confirms this request
@Component
@RequiredArgsConstructor
@DisputeModeBootStrapComponent(DisputeMode.REFUND)
public class RFBootstrapAwaitingAcknowledgement  implements DisputeBootstrapGuard  {
    private final DisputeService disputeService;

    @Override
    public DisputeState getTargetState() {
        return DisputeState.AWAITING_ACQUIRER_VERIFICATION;
    }
